...
public interface AssetManagementService {
     ...
     boolean deleteVehicle(int no)  throws BookingNotFoundException;
     String getUsername(int rideCount,int no) throws BookingNotFoundException;
     String getRideCount(int no) throws BookingNotFoundException;
}
